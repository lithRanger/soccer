            ...
            <td>
                <div class="row">
                    <div class="col-sm-8 col-xs-12">
                        ...
                        <input <?php echo $item['extend']; ?> type="text" name="row[<?php echo $item['name']; ?>]" value="<?php echo htmlentities($item['value']); ?>" class="form-control datetimepicker" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>"/>
